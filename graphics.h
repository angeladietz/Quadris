...
class Graphics : public Gtk::Window, public Observer {

public:
  Graphics(BaseObjectType *cobject, const Glib::RefPtr<Gtk::Builder> &builder,
           Controller *controller, Board *board, Quadris *quadris);
  ~Graphics();
  ...
  public:
    CDrawingArea(BaseObjectType *cobject,
...
private:
  ...
  vector<vector<CDrawingArea *>> drawBlocks =
      vector<vector<CDrawingArea *>>(18, vector<CDrawingArea *>(11));
  vector<vector<CDrawingArea *>> nextBlock =
      vector<vector<CDrawingArea *>>(4, vector<CDrawingArea *>(4));
