...
public:
  ...
  // Rotation is dependent on the kind of block so it is defined as a virtual
  // method
...
protected:
  // Private helper methods - do not need to be exposed to the client (i.e.
  // Board)
  ...
  // Do not need to be exposed to client programmer but are dependent on the
  // kind of block Thus are required to be virtual
